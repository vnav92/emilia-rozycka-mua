    ...
    <LimitedWidthContent className={classNames(styles.faqSection, styles.darkBackground)}>
        ...
        <div className={styles.faqList}>
          ...
          <FaqItem
            ...
            itemDescription={'W dużej mierze pracuję z dojazdem do klienta. W ramach pakietów ślubnych dojeżdżam do swoich klientów głównie na terenie woj. pomorskiego, kujawsko-pomorskiego i warmińsko-mazurskiego. Sesje zdjęciowe oraz makijaże biznesowe, korporacyjne wykonuję w Trójmieście i okolicach. Na pojedyncze makijaże, lekcje makijażu i kursy zapraszam do mojej pracowni w Gdańsku Morena.'}
          />

          <FaqItem
            itemHeading={'Czy możliwy jest dojazd do klientki? Jaki jest cennik?'}
            itemDescription={'W weekendy w sezonie ślubnym nie dojeżdżam do pojedynczych klientek. W takim przypadku zapraszam Cię do mojej pracowni w Gdańsku Morena. Dojazd możliwy jest w ramach pakietu ślubnego, o którym więcej przeczytasz w zakładce MAKIJAŻ ŚLUBNY. Jeśli masz jakieś wątpliwości lub nietypowe zlecenie dla mnie (szczególnie w dni robocze) - skontaktuj się ze mną!'}
            faqRedirectionLinkText={'Wyślij wiadomość'}
          />

          <FaqItem
            itemHeading={'Czy zajmujesz się również włosami? Jeśli nie - czy polecasz kogoś?'}
            itemDescription={'Makijaż to moja największa pasja i oddaję się jej w 200%. Swoje włosy w ważnym dla nas dniu lepiej oddać w ręce profesjonalnej stylistki fryzur. Gorąco polecam moje koleżanki i kolegów, pracujących na terenie Trójmiasta i okolic: Bartek Wysocki (Hairmate Gdańsk), Polka. Fryzury, warkocze., Masza Mikova.'}
          />

          <FaqItem
            itemHeading={'Jak zapisać się na pojedynczą usługę?'}
            itemDescription={'Napisz proszę do mnie wiadomość na Facebooku/Instagramie lub wyślij maila z następującymi informacjami: jaka ilość i rodzaj usługi Cię interesuje, data i godzina usługi, w przypadku dojazdu - adres miejsca przygotowań. Po ustaleniu wszystkich szczegółów podsyłam dane do zadatku, który jest potwierdzeniem rezerwacji wybranego terminu.'}
          />

          <FaqItem
            itemHeading={'Jestem przyszłą Panną Młodą. Czy mogę już zabookować termin na 2023 rok?'}
            itemDescription={'Aktualnie zapisy są otwarte do końca marca 2023. Na miesiące kwiecień - październik 2023 obowiązuje następujący harmonogram: 1 XI 2022 rozpoczynam zapisy na pakiety ślubne z dojazdem do klienta. 16 I 2023 rozpoczynam zapisy na makijaże indywidualne, które będą odbywać się w moim studio w Gdańsku Morena.'}
          />

          <FaqItem
            itemHeading={'Jestem zdecydowana na pakiet ślubny! Co dalej?'}
            itemDescription={'Napisz do mnie! Po ustaleniu wszystkich szczegółów wysyłam Ci podsumowanie rezerwacji i umowę, którą podpisujemy on-line lub osobiście podczas makijażu próbnego. W razie jakichkolwiek pytań związanych z umową jestem cały czas do Twojej dyspozycji.'}
            faqRedirectionLinkText={'Wyślij wiadomość'}
          />
          ...
          <FaqItem
            ...
            itemDescription={'Nie ma dobrego makijażu bez dobrej pielęgnacji :) Dlatego o skórę warto dbać regularnie i z odpowiednim wyprzedzeniem! Bardzo ważne jest codzienne nawilżanie twarzy i picie wody. Ewentualna wizyta na solarium/plaży powinna odbyć się najpóźniej dwa tygodnie przed makijażem. W przypadku aplikacji samoopalacza/opalania natryskowego polecam omijać okolice twarzy. Około 3 dni przed makijażem polecam wykonać przetestowany wcześniej peeling enzymatyczny. W przypadku osób depilujących brwi i wąsik - zabiegi te najlepiej wykonać najpóźniej 3 dni przed wizytą. W dniu umówionej wizyty najlepiej nie nakładać makijażu/filtru SPF lub wykonać dwuetapowe oczyszczanie twarzy i nałożyć pielęgnację bezpośrednio przed wizytą. Na makijaż proszę przyjść w koszulce na ramiączkach lub odpinanej koszuli. Na makijaż próbny ślubny najlepiej ubrać coś w kolorze docelowej kreacji. Polecam zabrać ze sobą biżuterię, przygotować zdjęcia swojego stroju, inspiracje makijażowe. Dobrym pomysłem jest umówienie się tego samego dnia na makijaż próbny, fryzurę próbną i/lub przymiarkę sukni ślubnej.'}
          />
        </div>
    </LimitedWidthContent>
  );
