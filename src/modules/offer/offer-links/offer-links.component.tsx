...
import { OfferGrid, LimitedWidthContent, SectionHeader, TypographyColor, Typography } from '../../../components';
...
export const OfferLinks: React.FC<OfferLinksProps> = ({
  ...
  return (
    ...
    <div className={styles.headingSection}>
      ...
      <Typography as="p" className={styles.description} color={TypographyColor.PRIMARY}>
          {sectionDescription}
      </Typography>
    </div>
      <OfferGrid />
